<template>
    <main class="course-content">
        <div class="video-container">
            ...
            <iframe class="video-frame" src="https://www.youtube.com/embed/7StArwBZTQA?si=dhvh1Izf1Fe1fahK"
        ...
        <img src="../../assets/images/foto001.png" alt="Rosa chegando aos EUA" class="responsive-image">
        <div class="dialogue-box">
            <p class="dialogue">
                <strong>Rosa:</strong> Nice to meet you, girls!<br>
                <strong>Carly:</strong> Nice to meet you too.<br>
                <strong>Christine:</strong> Welcome to your new home!<br>
                <strong>Carly:</strong> Where are you from in Brazil?<br>
                <strong>Rosa:</strong> I’m from Rio de Janeiro. And you? Are you from Chicago?<br>
                <strong>Christine:</strong> I’m from New York!<br>
                <strong>Carly:</strong> I’m from a small town in California.<br>
                <strong>Rosa:</strong> I’m curious to see my bedroom!<br>
        ...
        <iframe class="responsive-video" width="560" height="315"
            src="https://www.youtube.com/embed/EaTAkIC-qLM?si=zf2MyBdIg-Qw0jpL" title="YouTube video player"
            frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Vejo você amanhã</td>
                    </tr>
                    <tr>
                        <td>See you later</td>
                        <td>Vejo você depois</td>
                    </tr>
                    <tr>
                        <td>See you soon</td>
                        <td>Até breve / Até logo</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="content-table">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>My Name is (Christine Miller)</td>
                        <td>Meu nome é (Christine Miller)</td>
                    </tr>
                    <tr>
                        <td>I'm (Christine Miller)</td>
                        <td>Eu sou (Christine Miller)</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="dialogue-box">
            <p class="dialogue">
                ...
                <strong>Rosa:</strong> Good morning. My name is Rosa Souza.<br>
                <strong>Mr. Smith:</strong> It’s nice to meet you Miss Souza.<br>
                <strong>Rosa:</strong> Nice to meet you too, Mr. Smith.<br>
                <strong>Mr. Smith:</strong> Where are you from, Miss Souza?<br>
                <strong>Rosa:</strong> I’m from Brazil.<br>
                <strong>Mr. Smith:</strong> Oh, nice! Here is your schedule. It’s a pleasure to have you as our
                student.<br>
                <strong>Rosa:</strong> Thank you, Mr. Smith.<br>
        ...
        <p>Como há mais de uma expressão, você pode utilizar a que se sentir mais à vontade. Por outro lado, se alguém
            ...
            responder.</p>
        <div class="highlights">
            <span>Pleased to meet you too.</span>
        ...
        <div class="content-table">
            <h4>Quadro 4 - Polite expressions</h4>
            <table>
                <thead>
                    <tr>
                        <th>Polite expressions</th>
                        <th>Expressões de cordialidade</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td>Thank you / Thanks (informal)</td>
                        <td>Muito obrigado / Obrigado</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>I’m sorry / Sorry</td>
                        <td>Desculpe / Sinto muito</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="dialogue-box">
            <p class="dialogue">
                <strong>Sir:</strong> quando você se dirigir a um homem, em geral adulto, casado ou solteiro, sem
                utilizar seu nome ou sobrenome;<br>
                <strong>Ma'am (AmE) / Madam (BrE):</strong> quando você se dirigir a uma mulher adulta sem utilizar seu
                nome ou sobrenome;<br>
                <strong>Miss + last name:</strong> quando você se dirigir a uma mulher solteira e, em geral, jovem;<br>
                <strong>Mr + last name:</strong> quando você se dirigir a um homem, casado ou solteiro;<br>
                <strong>Ms + last name:</strong> utilizado quando alguém se dirige a mulher adulta que pode ou não ser
                casada. É frequente em ambientes de trabalho, onde o estado civil das mulheres não é relevante;<br>
                <strong>Mrs + last name:</strong> quando você se dirigir a uma mulher casada que utiliza o sobrenome do
                marido;<br>
                <strong>Professor + last name:</strong> quando você se dirigir a (ou falar sobre) um professor
                universitário.
            </p>
        </div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Second name</td>
                        <td>Middle name</td>
                        <td>Surname / Last name/ Family name</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="dialogue-box">
            <p class="dialogue">
                ...
                <strong>Rosa:</strong> Hi, I'm Rosa… Rosa Souza. S-O-U-Z-A.<br>
                <strong>Attendant:</strong> Rosa Souza?<br>
                <strong>Rosa:</strong> Yes, Rosa Souza.
            </p>
        </div>
        <iframe class="responsive-video" width="560" height="315"
            src="https://www.youtube.com/embed/IyX57Avej-s?si=XKqji4dcmAIvBGB1" title="YouTube video player"
            frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        ...
        <iframe class="responsive-video" width="560" height="315"
            src="https://www.youtube.com/embed/sJk8h5gYm4A?si=IOX0MOD64VPJZFYt" title="YouTube video player"
            frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
