...
const pageComponents: Record<string, Record<string, () => Promise<any>>> = {
    ...
    "04": {
        "01": () => import("../views/Ingles04/Pag01.vue"),
        "02": () => import("../views/Ingles04/Pag02.vue"),
        "03": () => import("../views/Ingles04/Pag03.vue"),
    },
    "05": {
        "01": () => import("../views/Ingles05/Pag01.vue"),
        "02": () => import("../views/Ingles05/Pag02.vue"),
        "03": () => import("../views/Ingles05/Pag03.vue"),
    },
    "06": {
        "01": () => import("../views/Ingles06/Pag01.vue"),
        "02": () => import("../views/Ingles06/Pag02.vue"),
        "03": () => import("../views/Ingles06/Pag03.vue"),
    },
};
